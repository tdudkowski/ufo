...
const About = () => {
    return (
        <Layout>
            ...
            <p>Wycieczki ze mną prowadzone są w odpowiedni sposób i dostosowane do grupy. Potrafię zainteresować dzieci i dorosłych. Zapewniam, że każdy wyjdzie z wycieczki z nową wiedzą oraz zainteresowaniem dla pięknego regionu, jakim jest Dolny Śląsk.</p>
            ...
            <ul>
                ...
                <li>Pilot wycieczek krajowych i zagranicznych</li>
                <li>Przewodnik miejski po Wrocławiu</li>
                <li>Instruktor przewodnictwa PTTK</li>
                <li>Przodownik Turystyki Górskiej na Sudety i Beskidy Zachodnie</li>
                <li>Honorowy Członek Studenckiego Koła Przewodników Sudeckich</li>
            </ul>
        </Layout >)
}
